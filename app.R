...
ui <- page_navbar(title = text["text_1"],
  ...
  nav_panel(title = text["text_2"],
            ...
            page_fluid(
              ...
              card(
                card_header(text["text_131"]),
                p(HTML(text["text_132"]))
              ),
              card(
  ...
  #' Definitions Tab
  nav_panel(title = text["text_131"],
            titlePanel(h1(text["text_131"], style = 'color:white; font-weight: bold;')),
            card(
              card_title(text["text_133"]),
              p(HTML(text["text_134"])),
              p(HTML(text["text_135"])),
              p(HTML(text["text_136"])),
              p(HTML(text["text_137"])),
              p(HTML(text["text_138"])),
              p(HTML(text["text_139"])),
              p(HTML(text["text_140"])),
              p(HTML(text["text_141"])),
              p(HTML(text["text_142"])),
              p(HTML(text["text_143"])),
              p(HTML(text["text_144"])),
              p(HTML(text["text_145"])),
              p(HTML(text["text_146"])),
              p(HTML(text["text_147"])),
